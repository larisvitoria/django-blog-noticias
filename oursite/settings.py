...
SECRET_KEY = 'django-insecure-ph4j!3*n^9ho-5ox9!p1yvhv(m1p0)7kr^9naa4a0^n7cs6xd#'
...
LANGUAGE_CODE = 'pt-br'  # Configura o idioma para português do Brasil
TIME_ZONE = 'America/Sao_Paulo'  # Configura o fuso horário para o horário de Brasília
USE_I18N = True  # Ativa a internacionalização (i18n)
USE_L10N = True  # Ativa a localização (l10n) para formatos de data, número e moeda
USE_TZ = False  # Desativa o suporte a fusos horários (time zones) - Brasília já é o fuso horário padrã
